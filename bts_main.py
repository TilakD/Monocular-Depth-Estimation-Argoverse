...
'''
python3 bts_main.py arguments_train_resnext101.txt
'''
...
parser = argparse.ArgumentParser(description='BTS PyTorch implementation for Argo.', fromfile_prefix_chars='@')
...
parser.add_argument('--save_freq',                 type=int,   help='Checkpoint saving frequency in global steps', default=15000)
